...
export const SEED_SITES: SiteRecord[] = [
  ...
  mk("https://senin.click", [], 44, 34, 12, 170, null, "Reinício financeiro e recuperação após crises financeiras para o público brasileiro"),
  mk("https://sashko.pro", [], 35, 35, 15, 491, null, "SaaS para pequenas empresas brasileiras"),
  mk("https://pelit.click", [], 42, 44, 12, 758, null, "Jogos premium (AAA), hardware gamer de alto valor, consoles e periféricos premium"),
  mk("https://pedis.click", [], 13, 17, 12, 13, null, "Automação, Checkout, E-commerce, Vendas pelo WhatsApp, Instagram e Marketplaces"),
  mk("https://nikke.blog", [], 36, 33, 13, 135, null, "Ouro, Prata, Platina, Níquel e Commodities & Proteção Patrimonial"),
  mk("https://nalgonas.org", [], 52, 38, 12, 277, null, "Treino de glúteos, fortalecimento funcional, hipertrofia, anatomia muscular, nutrição esportiva"),
  ...
  mk("https://rankoffers.com", ["valemarketing5@gmail.com"], 1, 16, 14, 9, null, "Reviews Marketing de afiliados, ofertas CPA, Reviews rank de ofertas"),
  ...
  mk("https://gaiacreative.com.br", [], 31, 27, 15, 100, null, "Agência para Agência B2B, publicidade, marketing, inovação"),
  mk("https://upira.com.br", ["danielmoreira30@gmail.com"], 29, 23, 10, 111, null, "Estilo de vida off-grid, sustentabilidade, natureza"),
  mk("https://helplistas.com.br", ["damarisglendha@gmail.com"], 26, 24, 7, 81, null, "Listas de ajuda, Lista de Mercado, Lista de Casamento, Listas Escolares"),
  ...
  mk("https://duiwin.pro", [], 37, 39, 11, 344, null, "Trading, investimentos, ações, fundos imobiliários, criptomoedas, análise técnica"),
